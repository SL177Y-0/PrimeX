...
import { ArrowLeft, Send, Shield, AlertTriangle, Home, TrendingUp, Wallet, Settings } from 'lucide-react-native';
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.bg }]}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.confirmButtonText}>Withdrawal Now</Text>
        </GradientPillButton>
      </ScrollView>
